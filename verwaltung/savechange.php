...
$query_text = "UPDATE stellen SET lat=$lat, lng=$lng, Titel=$Titel, Problem=$Problem, Kategorie=$Kategorie, Bearbeitungsstatus=$Bearbeitungsstatus, Bild=$Bild WHERE id=$id;";
//echo $query_text;
